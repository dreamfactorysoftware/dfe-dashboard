...
<div class="container-fluid col-xs-12 col-sm-10 col-sm-offset-1 user-dashboard">
    <!--	<div class="alert alert-fixed alert-danger">
                    <h4>System Alert</h4>
            <p>We are currently experiencing a problem with our hosted provisioning system. Our engineers are hard at work correcting the issue.</p>
            <p>We will update this message periodically.</p>
            </div>
    -->
