...
?>
<div id="loginbox">
	<div class="dsp-system-name"><img src="/img/logo-login-128x128.png" class="dsp-system-logo" />DreamFactory Services Platform&trade;<div
			class="dsp-system-tagline">Free Hosted Edition Dashboard
		</div>
	</div>

	<form id="form-login" method="POST" role="form">
		<input type="hidden" id="check-remember-ind" value="<?php echo $model->remember_ind; ?>">
		<div class="form-group normal_text logo-container"><h3><img src="/img/logo-256x256.png" alt="" /></h3></div>
		...
		<div class="form-group">
			<div class="input-group remember-me">
				<span class="input-group-addon bg_db"><i class="fa fa-<?php echo !empty( $model->remember_ind ) ? 'check-' : null; ?>circle-o fa-fw"></i></span>
	...
	<form id="form-recover" target="_blank" action="https://www.dreamfactory.com/user/password" method="POST">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input tabindex="1" id="edit-name" name="name" class="form-control email required" autofocus type="email" placeholder="Email Address" />
			</div>
		</div>

		<div class="form-buttons">
			<span class="pull-left">
				<button tabindex="3" type="button" class="flip-link btn btn-info" id="to-login"><i class="fa fa-double-angle-left fa-fw"></i> Back to login
				</button>
			</span>
