...
/**
 * @file
 * This is the template for the popup import dialog
 *
 * @var \stdClass $user
 */
?>
<div id="dsp-import-snapshot" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="dsp-import-snapshot-label" aria-hidden="true">
	...
	<form id="_dsp-snapshot-control" method="POST">
		...
		<div class="modal-body">
			...
			<p>Please Note: <strong><em>This is a destructive process</em></strong>.<br />
				You will permanently lose any and all data associated (not including snapshots) with this DSP when you import a snapshot.</p>
