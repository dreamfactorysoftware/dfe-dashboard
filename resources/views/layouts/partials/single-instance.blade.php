    ...
    <div class="panel {{ $panelContext }} panel-instance">
        ...
        <div class="panel-heading" role="tab">
            <h4 class="panel-title" data-instance-name="{{ $instanceName or 'NEW' }}">
                @if(isset($collapse))
                    <a data-toggle="collapse" data-parent="#panel-accordion" href="#{{ 'panel-body-' . $instanceName }}">
                        @endif
                        @if ( isset($headerIcon) )
                        ...
                        @section('panel-toolbar')
                            @if ( isset($toolbarButtons) && !empty($toolbarButtons) )
                                <div class="instance-actions"
                                    ...
                                    aria-expanded="false"
                                    aria-controls="instance-toolbar-{{ $instanceName }}"><i class="fa fa-fw fa-angle-down"></i>
                                </div>
