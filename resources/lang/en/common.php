...
HTML
    ...
    'instance-package-help'        => '<p class="help-block">Select an existing package file (*.zip or *.dfpkg) to upload from your system and click the <strong>Upload</strong> button.</p>',
    //******************************************************************************
