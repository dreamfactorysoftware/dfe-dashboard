...
<div class="row partner-row">
    ...
    <div class="col-md-8 col-sm-8 partner-copy"><h3>Deploy DreamFactory to your own server hosted on the Verizon Cloud.</h3></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Signing up for Verizon Cloud services allows you to host a DreamFactory instance on your own server outside of this free sandbox environment you are currently in.</p>
